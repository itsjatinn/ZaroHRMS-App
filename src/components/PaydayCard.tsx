...
export default function PaydayCard() {
  return (
    <View style={cardShadow} className="flex-1 rounded-[24px] border border-white/10 bg-[#14323F] p-5">
